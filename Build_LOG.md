...
- Added an automatically refreshing month-over-month dashboard card with plain-language increase or decrease messaging while preserving signed API values.
- Notes:
